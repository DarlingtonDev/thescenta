...
const NewPost = () => {
  ...
  return (
    <div className="w-full lg:ml-[15%] lg:w-[85%] px-4 sm:px-6 bg-gray-50 mt-14 min-h-screen py-6">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 mb-8">
        ...
        <h1 className="text-xl sm:text-2xl font-semibold text-gray-900 font-inter">
          Create New Post
        </h1>
      </div>
      ...
      <div className="max-w-4xl mx-auto w-full">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="px-4 sm:px-8 py-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
          ...
          {/* Form Content */}
          <form className="p-4 sm:p-8 space-y-8" ref={postForm}>
            {/* Title Input */}
